# Portfolio — Analisi indipendente

Dashboard interattive per l'analisi del portafoglio finanziario.

> ⚠️ **Accesso riservato** — Questo sito non è indicizzato dai motori di ricerca. Solo chi possiede l'indirizzo diretto può accedere alle pagine.

## Pagine disponibili

| Pagina | Descrizione |
|--------|-------------|
| [Index](https://scalvini.github.io/portfolio/) | Pagina principale con link a tutte le analisi |
...
- HTML standalone — nessun framework, nessun build
- CSS variables con dark mode automatica
- Chart.js 4.4.1 (da CDN) per i grafici
